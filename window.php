...
$category = mysql_query("SELECT * FROM wp_resservation");
?>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<title>Insert Appointment Manager</title>
<!-- 	<meta http-equiv="Content-Type" content="<?php// bloginfo('html_type'); ?>; charset=<?php //echo get_option('blog_charset'); ?>" /> -->
	<script language="javascript" type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-includes/js/tinymce/tiny_mce_popup.js"></script>
	<script language="javascript" type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-includes/js/tinymce/utils/form_utils.js"></script>
	<script language="javascript" type="text/javascript" src="<?php echo get_option('siteurl') ?>/wp-content/plugins/js-appointment/tinymce.js"></script>
    <base target="_self" />
</head>
	...
	<form name="allbook" action="#">
		<table border="0" cellpadding="4" cellspacing="0">
         <tr>
            ...
            <option value="ALLBOOK"><?php _e("Appointment", 'allbook_main'); ?></option>
            <?php
